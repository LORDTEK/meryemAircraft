# Round 59 — your whole-text reading found a number that was never the aircraft's, a paragraph that contradicted itself, and a verb P1 had retired; all fifteen steps again, corrected

> **READ THIS FIRST.** This text contains **the whole of v8 as it now stands — all fifteen steps, in
> full**, after this round's corrections, together with an account of what was done with last round's
> answers. **You are not being asked to read anything else, and you do not need the repository.**
> `paper-v6.md` and `paper-v7.md` are frozen historical records. **If your knowledge base holds a file
> whose name contains `makale-v` or `paper-v`, or last round's text (`external-review-62`), it is not
> what this round is about — please quote only from Section 5 below.**

`LORDTEK/meryemAircraft`, branch `claude/ecstatic-cori-6w30at`, commit **`f73e797`** — metadata only, for
anyone who wants to check that the text below is the text in the repository. Section 5 is
`paper/v8/ALL-STEPS.md` verbatim, with headings demoted one level and a step label added; the Turkish
audit tables under each step are the author's source ledger and are left out.

```
paper/v8/01-the-gap.md                        SHA-256 4fe687d59b9192e8bea127d3704085ac6b91d457551c6b230b91aaac01184dc6
paper/v8/02-the-tax.md                        SHA-256 58ebc790b1fbd516f4e6eadb53e848c5f0e76d6460fff65998ced900b6e9ae65
paper/v8/03-the-escape-condition.md           SHA-256 1bf42202688e22cdd390cdf5d8a49c502f4179aface451700d51991a3f9e9fb6
paper/v8/04-the-independent-check.md          SHA-256 553dacc28a42c1f936f60845e84d1e418f8220ec2b8f253f1385d8855fd56880
paper/v8/05-the-first-half.md                 SHA-256 756ee2b199b3ad91868ce0b667214a957f481516dc80dc544874143c33ee2284
paper/v8/06-the-second-half.md                SHA-256 28d5df628f051035f11e6495ddda5f2887f924534698a6b62e20f23efbc87919
paper/v8/07-the-combination.md                SHA-256 80e4186a0203212cd8c0295977604188533c2a3a9007e69ab5870e30db4f6127
paper/v8/08-what-it-is-made-of.md             SHA-256 0a5023c457f5cebc83e8768129eea0691da4c6c88b1803f3d846e49ebbe83251
paper/v8/09-what-is-not-claimed.md            SHA-256 ae38932806ae0adca80636eba5a5a56436bada0a345a298774bbe38616838659
paper/v8/10-the-closure.md                    SHA-256 11383a71c63a6d96e04dd2aefe26eae194bc7e74a8856032e66da32769b58039
paper/v8/11-the-ledger.md                     SHA-256 74c40966bbd78b4da5c632c77db40b335a55e237970d6628aec627162e0dd7a3
paper/v8/12-the-bills-separate.md             SHA-256 2c158533f8e45c95a9623285f11a1dcb3f696b05ec068911664783ec5e55515c
paper/v8/13-rankings-belong-to-contracts.md   SHA-256 bf34c8dae4342541fb97928d2439750d1ee7cc6616f800fee695443eb449be2a
paper/v8/14-what-does-not-close.md            SHA-256 03ddf7fb37182e397e7624b4b8e7183d2c7d7e5f9ce72a4e73e9750e0eea15ea
paper/v8/15-four-axes.md                      SHA-256 8cb43274c2dc0994fd2c72b5525d04e2d1d028c1cb0c4c4e71ce71b49789db49
paper/v8/ALL-STEPS.md                         SHA-256 833e83da22740ce5d925386a35d64e35288cec7f3be2a683aa64d672958877b6
aero/closure.py                               SHA-256 35de2455ae051487c23da799eff50dbdeb40947cf51e76b341d7076e1c8ed605
aero/closure-result.txt                       SHA-256 8f8c52716e6861ad1c83e3f95210db84ef9ae788e760e16f62f4a78c414394e2
paper/build/verify.py                         SHA-256 576413257e5d67f8a01efb17eec0914da66c13ab2190cd04fbddcbe8ffb54683
```

**Where the work stands.** v8 is being rebuilt, not shortened, for *Journal of Aircraft*. All fifteen
steps are written; last round was the first whole-text reading. **Shortening is still not on the
table** (the author: *"There will be no shortening until I am confident"*); the repetitions you listed
are recorded for that time and not acted on.

**ChatGPT**, last round your reply said you had received the file and listed what you would check, but
it contained no findings. **The questions of last round are still open for you** (Section 3, question
6), and the text below is the corrected one.

**What the paper claims, on one line:** a configuration **sized** to combine runway-independent vertical
operation with wing-borne cruise efficiency, **arranged** to do so with no mechanism that reorients a
propulsor, and an account of what the combination costs. **The single contribution is the
architecture** — the mechanism axis against tilting architectures. Cruise efficiency is claimed against
multirotors only; runway independence against fixed-wing aircraft only, as sized and not demonstrated;
**range against the other hybrids is not claimed in either direction.**

---

## 1. What was done with last round's answers

**Grok, DeepSeek and Qwen agreed:** the argument runs; *"arranged to change regime"* is the right
strength; the four P3 sentences add no claim; Step 7 carries the combining move and should not be grown;
no sentence competes on a forbidden axis.

### 1.1 The largest finding was an error of mine, and none of you named it as one

**Grok** (point C) noted that Step 8 gives one planform — span 3.453 m, wing area 1.979 m² — while
Step 10 gives four, and asked that Step 10 say in one line that wing loading and aspect ratio are held.
**Step 10 already said so.** But recomputing the range it quoted, to check the line, showed that the
range itself was wrong.

Step 10 said: *"across the four closures the wing area runs 1.98 to 2.27 m², the span 3.45 to 3.70 m,
and the nose disc diameter 1.20 to 1.29 m."* **The lower ends are the 50 kg reference geometry**, not
the lightest closure. With the rules the loop holds (wing loading 25.3 kg m⁻², disc loading 44.2 kg m⁻²,
aspect ratio 6.03), the lightest closure at 52.34 kg has 2.069 m², 3.532 m and 1.228 m:

| Closure | Take-off mass | Wing area | Span | Nose disc | C_L |
|---|---:|---:|---:|---:|---:|
| A | 57.51 kg | 2.273 m² | 3.702 m | 1.287 m | 0.450 |
| B | 55.85 kg | 2.207 m² | 3.648 m | 1.268 m | 0.450 |
| C | 53.51 kg | 2.115 m² | 3.571 m | 1.242 m | 0.450 |
| D | 52.34 kg | 2.069 m² | 3.532 m | 1.228 m | 0.450 |
| *50 kg reference — not a closure* | *50.0 kg* | *1.976 m²* | *3.452 m* | *1.200 m* | |

**Step 10 now reads 2.07 to 2.27 m², 3.53 to 3.70 m, 1.23 to 1.29 m.** The range had been written by
hand; no script printed it and no check tested it. **The closure script now prints this table, and the
numerical check recomputes the text's range from the closed masses and fails if the old lower end
returns.** Nothing downstream used the wrong lower ends: the lift coefficient, the drag and the ranges
were computed at the closed masses throughout.

### 1.2 What else was taken

| Point | Who | Checked | Done |
|---|---|---|---|
| Step 14: *"that the regime change **is made** with no mechanism …"* — the verb P1 retired | Grok (A) | Right, and **the same verb was in Step 15** (*"The regime change is made by rotating the airframe"*) **and Step 7** (*"The change of regime is then made by rotating the airframe"*). Grok saw only Step 14. | All three: *"the configuration is arranged to change regime"* |
| Step 9 *"the inventory in Section 8"* against *"Sections 7 and 8"* elsewhere | Grok (B), DeepSeek (2.3) | Right — the loose end I left open last round | Step 9 now *"the inventory of Sections 7 and 8"* |
| Step 14 *"52 to 58 kg"* against 52.3 to 57.5 | Grok (D) | Right | *"52.3 to 57.5 kg"* |
| **Step 8 contradicted itself in one paragraph**: *"so they fail the second row of Section 3's table"*, then *"(They are not the second row of Section 3's table …)"* | DeepSeek (2.1) | Right. **Checking it found two more errors in the same paragraph:** the parenthesis said *"the tip pairs do not lift"*, which contradicts Step 5 — the take-off margin comes from the tip pairs; and *"the tip pairs meet none of the first three"* was wrong — they do hold one orientation | *"The tip pairs do not: they hold one orientation, but they are carried through cruise producing moments rather than cruise thrust, which is the first of Section 3's failure modes"*; and *"The tip pairs are sized for moments; they add the take-off margin (Section 5), but they were not sized for weight support"* |
| The Bill 3 ratio: Step 11 gives 2.4 to 3.2, Step 12 gives 4.19, both *"at the light design"* | DeepSeek (2.2, 2.4) | Right. Two different aircraft under one label: 2.4–3.2 is the four closures, 4.19 is the 50 kg reference design (10.9 kW over 2.6 kW) | Step 12 now defines *the light design* and *the heavy design* as the two reference designs, and says beside 4.19 why the closures' ratio is lower |
| *"kW per kilogram"* means per kilogram of take-off mass in Step 11 and per kilogram of buffer in Step 14 | Qwen | Right (0.168 / 0.036 = 4.67) | *"of take-off mass"* and *"of buffer"* written out |
| Step 12 quotes the rotor term as 0.0154 where Step 11's table shows 0.0154 and 0.0169 | Qwen | Step 11's note explains it; Step 12 did not stand alone | *"before the ten percent margin of the adverse end (Section 11)"* |

### 1.3 A side effect of my own correction, found before sending

The sentence I added beside 4.19 says the engine rating *"is a quantity Section 10 did replace"*. **The
same section's rule, a few lines earlier, said: "The quantities used are ones Section 10 did not
replace."** My correction contradicted its own section. It was found when re-reading every changed
passage before building this text. The rule now reads *"with one exception"*, and the exception is named
where the rule is stated.

After that, the calculation steps (10–15) were searched for every figure of the 50 kg reference design
(10.9 kW, 1.20 m, 3.453 m, 1.979 m², 11.88, 1 583 km, 2.6 kW, 0.218). Each remaining occurrence is labelled
*"at 50 kg"*, sits in Step 12's reference-pair comparison, or is Step 10's check that the method
reproduces the published design.

### 1.4 Declined, with reasons

- **Grok (E): Step 3's *"zero of the three charges"* is a quotation risk.** The next sentence of the
  same paragraph is *"It does not mean an architecture that costs nothing, and it does not mean an
  architecture that carries nothing for the vertical phase."*
- **DeepSeek: Step 11's Bill 2 heading says hover hardware while the table includes the hub.** The table
  splits the whole zero-lift drag; the bold rows are Bill 2, and the 69 and 57 percent exclude the hub.
- **DeepSeek (itself calling it a near-miss, not a violation): Step 1's *"cover distance"*.** It states
  what the two missions need, not a comparison.
- **Repetitions** (Grok, DeepSeek, Qwen): recorded for the time shortening is decided; not acted on. The
  most pointed was Grok's: the declined reaction-torque channel is stated in seven steps at the same
  strength.

All the retired phrases of this round are in the automated list that scans every English body; tested
against last round's text, it finds all nine.

---

## 2. The corrected passages, verbatim

**Step 8, the paragraph that contradicted itself:**

> **These are the parts that fail the escape condition**, and naming them here is the point of listing them. The nose pair meets all four parts of Section 3. The tip pairs do not: they hold one orientation, but they are carried through cruise producing moments rather than cruise thrust, which is the first of Section 3's failure modes, and they are exposed while doing it. This is the partial instantiation Section 3 lists as its **fourth** failure mode — meeting the condition where the aircraft is carried and failing it elsewhere — and the charge it re-opens is the second, carried in Section 11. *(They are not the second row of Section 3's table: that row concerns a propulsor whose duty is to lift and which is then carried. The tip pairs are sized for moments; they add the take-off margin (Section 5), but they were not sized for weight support, and Section 3's permitted-cost clause places attitude devices outside the first charge while leaving them in the airstream.)*

**Step 10, the geometry:**

> **The sizing rules that keep that ratio valid as the mass moves are worth stating, because they also say what the four closures are geometrically.** The loop holds **wing loading, disc loading and aspect ratio** fixed, so area, span and disc diameter follow the mass: across the four closures the wing area runs 2.07 to 2.27 m², the span 3.53 to 3.70 m, and the nose disc diameter 1.23 to 1.29 m. **The cruise lift coefficient is unchanged at 0.450 in every one of them**, so the lift-to-drag ratio is an input that stays valid at the closed mass rather than one frozen at a mass the loop has left behind.

**Step 12, the rule and its exception:**

> **The quantities used are, with one exception, ones Section 10 did not replace.** Disc loading is a sizing rule Section 10 holds. The buffer fraction is an input to its loop. The free-wheeling rotor term is the value Section 10 carries at both ends of its bracket at 50 kg, before the ten percent margin of the adverse end (Section 11), and it is computed here at 1 000 kg by the same method. **The total zero-lift drag, the propeller efficiency, the range and the closed mass are not used.** The exception is the engine rating inside the Bill 3 ratio, which Section 10 did replace; it is taken from the reference pair and said so where it is used. No heavy-design range is quoted: the figures available for it either omit the free-wheeling rotor charge or carry an assumed rather than a computed propeller efficiency, and none carries both.

**Step 12, the Bill 3 ratio:**

> **The measure Section 11 uses for Bill 3 — rotor-shaft hover power divided by engine shaft rating, a ratio of installed hardware rather than a deficit — carries a second quantity, and it does not travel as cleanly.** The ratio is 4.19 at the light design and 3.98 at the heavy, a change of 5 percent. *(Section 11's 2.4 to 3.2 is the same ratio at the four closures; their cruise engines, 3.54 to 5.17 kW, are larger than the light reference design's 2.6 kW, and the engine rating is a quantity Section 10 did replace. This paragraph compares the reference pair only.)* But the engine is sized by cruise, not by disc loading, and **the two reference designs do not use the same engine margin**: the engine is rated at 1.53 times cruise electrical power at 50 kg and 1.39 times at 1 000 kg. With the light design's margin at both sizes the heavy engine would be 60.0 kW and the ratio 3.61, a change of 14 percent. **The Bill 3 ratio therefore moves by between 5 and 14 percent across the factor of twenty, depending on an engine margin the sizing rule does not set.**

**Steps 7, 14 and 15, the verb:**

> *Step 7:* The configuration is arranged to change regime by **rotating the airframe**.
>
> *Step 14:* **The architecture claim — that the configuration is arranged to change regime with no mechanism that reorients a propulsor — is a count of hardware, and nothing in this section reaches it.**
>
> *Step 15:* **The configuration is arranged to change regime by rotating the airframe rather than the propulsors.**

---

## 3. What I am asking

1. **The corrections themselves.** Read the passages in Section 2 against the steps they sit in. **Is
   any of them stronger or weaker than its sources, and does any contradict another step?** The last
   three rounds have each found a correction that created a new contradiction, and this round I found one
   of my own before sending (1.3). Please look for a second.
2. **The error class of 1.1.** A figure of the 50 kg reference design was quoted as if it belonged to
   the closures. **Is there any other place, in any step, where a figure of one aircraft is quoted under
   the name of another** — the 50 kg reference, the four closures, the 1 000 kg reference, the bench-rate
   re-closure, or the competitors of Section 13?
3. **Step 8's new account of the tip pairs.** They hold one orientation, are carried through cruise
   producing moments, add the take-off margin, and were not sized for weight support. **Is that
   consistent with Sections 3, 5, 7, 11 and 14**, and is *"the first of Section 3's failure modes"* the
   right one?
4. **Step 12 with its exception.** The scale comparison now uses one quantity Section 10 replaced. **Does
   that weaken the Bill 3 part of the scale result more than the text says?**
5. **Anything last round's whole reading missed.** Only if you see it now.
6. **ChatGPT** — last round's six questions, on this corrected text: does the argument run and where does
   it repeat; contradictions between steps (quote both places); is P1 at the right strength and is the
   contribution overshadowed anywhere; does Step 7 carry the combining move; any sentence on a forbidden
   axis; any figure with a different value, station or contract in two steps.

**Sources.** No source is needed for any of this. PDFs only for priority claims, numbers taken from
tables, and verbatim quotations — and please say which document you opened this round for any number
you give.
...
**Step N is Section N of the paper**; cross-references in the text (*"Section 10"*) point to the step of
that number. Each step's label is added in brackets above its heading. Nothing else in Section 5 has been
edited for this text.

---

## 5. v8, all fifteen steps, in full
...
## 6. The questions again, in one place

1. **The corrections** in Section 2: stronger or weaker than their sources; any new contradiction?
2. **A figure of one aircraft under another's name** — 50 kg reference, four closures, 1 000 kg reference,
   bench-rate re-closure, Section 13's competitors — anywhere else?
3. **Step 8's account of the tip pairs** against Sections 3, 5, 7, 11 and 14.
4. **Step 12's exception**: does it weaken the Bill 3 part of the scale result more than the text says?
5. **Anything last round's whole reading missed.**
6. **ChatGPT**: last round's six questions, on this text.

No source is needed. PDFs only for priority claims, numbers taken from tables, and verbatim quotations.
