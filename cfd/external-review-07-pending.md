...
bağımsız kaynakta uçan-wing/refleks kesitlerinin C_m,c/4'ü negatif çıkıyor ve
...
kursunun altından kademeli bir ölü bant kesiyor — `roll.py:esik_istasyonu()`:
...
`aero/viscous.py` yazıldı: VLM panel kuvvetlerinden her açıklık şeridinin yerel
