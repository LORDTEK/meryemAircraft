...
ayni vaka iki yerde farkli sayilarla gorundu. `verify.py` onu yakaladi ve
...
tablo da yenilenir; elle guncellenmesi gereken hicbir sayi kalmaz.
    ...
    python3 cfd/summary.py --md       README'ye yapistirilacak markdown
"""
import json, os, sys
...
BOLUM = [("A ailesi — sabit duvar aralığı (y+ = 1), yalnızca hücre sayısı ölçekleniyor",
         ...
         #     olculmeliydi ve olculdu (bkz. validation.md)
         ...
         #     olcusu DEGIL, isarettir (bkz. validation.md "DUZELTME").
