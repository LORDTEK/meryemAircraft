...
```
https://raw.githubusercontent.com/LORDTEK/meryemAircraft/main/paper/paper-v5.md
```

**The supplementary material** (S1–S6 in one file):

```
https://raw.githubusercontent.com/LORDTEK/meryemAircraft/main/paper/paper-v5-supp.md
```

Those are plain Markdown and will render as text. If your browsing tool prefers
a normal page, the same files are at
`github.com/LORDTEK/meryemAircraft/blob/main/paper/paper-v5.md` and
`.../paper-v5-supp.md`.
...
- `aero/thrust.py` — the thrust-budget script behind Section 2 below
