...
from real_mesh import gercek_istasyonlar                   # noqa: E402
from wing_mesh import KanatAgi                           # noqa: E402
from setup3d import kur3b                                 # noqa: E402

SEVIYE = (("orta", 28, 160, 64, 40), ("ince", 36, 192, 64, 48))
KOK = os.path.join(BURA, "data", "real3d")
ALFA = 6.69
...
if __name__ == "__main__":
    for ad, n, nf, nn, ni in SEVIYE:
        ...
        t = time.time()
        subprocess.run(["bash", os.path.join(BURA, "run3d.sh"), v, "4"],
                       check=False)
