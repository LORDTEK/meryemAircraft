...
NEDEN BOYLE. Iki boyutlu C-agi uretecinin (common/c_mesh.py) urettigi cozumler
...
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                "..", "ortak"))
from c_mesh import CAgi, ilk_hucre_yuksekligi
from c_mesh import naca4 as _naca4          # noqa: E402
...
class KanatAgi:
    ...
    def __init__(self, istasyon, Re=6e6, yplus=1.0, R=20.0, Xiz=20.0,
        ...
        # Uc secenek de olculdu; sonuclar validation.md'de.
        self.normal = normal
        ...
        # dahil; iz kesigi tabanin orta noktasindan baslar (bkz. c_mesh.py).
    ...
    def yaz(self, yol):
        ...
        #
        # Yerine tip_cap_mesh.py'deki halka + Coons cekirdek geldi. Iki boyutta
        ...
        if self.kw < NK:
            from tip_cap_mesh import kapak_agi
            kap = {}
            hucre_sablon = None
            ...
            for k in range(self.kw - 1, NK - 1):
                ...
                for r in range(NKAT - 1):
                    for pp in range(NP):
                        p2 = (pp + 1) % NP
                        # Sarim TERS cevriliyor: tip_cap_mesh.py'nin urettigi ilmek
