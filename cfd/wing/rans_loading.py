...
common/forces.py Aref = 1 kullaniyor, kanat alanini DEGIL; ustelik kok
...
from forces import ag_oku, son_zaman, Alan, hesapla      # noqa: E402
...
if __name__ == "__main__":
    ...
    from real_mesh import gercek_istasyonlar
