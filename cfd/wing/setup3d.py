...
ve turbulans kurulumunu YENIDEN YAZMIYORUZ; naca/setup.py cagriliyor ve
...
from setup import kur as kur2b                          # noqa: E402
...
def kur3b(dizin, ag, kok="symmetryPlane", uc="serbest", duvar_fonk=True,
    ...
    """ag: KanatAgi ornegi. kw, naca/setup.py'nin kur()'una gecer."""
    ...
    for ad in sorted(os.listdir(os.path.join(dizin, "0"))):
        ...
        if duvar_fonk:
            ...
            # bozuluyor, bkz. validation.md). Dusuk-Re duvar islemi o y+'ta
    ...
    #
    # Bu degisiklik YALNIZCA uc boyutlu vakaya uygulanir; naca/setup.py'ye
    ...
    #
    # naca/setup.py "consistent yes" (SIMPLEC) + U 0,9 kullaniyor ve iki
...
# run3d.sh ELDEN yazilan ayri bir dosyadir; buradan URETILMEZ. Onceki
