...
`makale-v5.md`, `makale-v6.md`, `makale-v6-ek.md` and `zenodo-v6.md` was meant.
...
| What | Direct link |
|---|---|
| **The manuscript** | `https://raw.githubusercontent.com/LORDTEK/meryemAircraft/535401f/makale/makale-v6.md` |
| Supplementary (6 files, one document) | `https://raw.githubusercontent.com/LORDTEK/meryemAircraft/535401f/makale/makale-v6-ek.md` |
...
`makale-v6.md`. A reader who downloaded both had two files with one name and no way to tell
