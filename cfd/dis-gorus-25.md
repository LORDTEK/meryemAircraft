...
below is cross-checked against `makale-v6.md`.
...
figures never went public. `makale-v5.md`, the deposited version, contains no
...
repository as `makale/kaynakca-zenodo-kiyas.md`.
