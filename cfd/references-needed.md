...
`cfd/source/` altına, indirildiği adı bozmadan. Sonra `cfd/data/`
içine sayısal tablolar çıkarılır ve `cfd/verify.py` karşılaştırmayı yapar.
...
yanlış sayıyı birinci el okumayla yakaladı (`paper/references.md`); ikinci
