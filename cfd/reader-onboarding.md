...
> Round 94. An older copy (Round 61, sent in Round 64) stated Step 13's contract results **in the reverse direction**: it
...
| Step 14 | recomposed; 14D, 14E, 14G and S-19 confirmed. R-3 ("four different kinds") and S-20 (the design study's own conclusion) applied, awaiting confirmation |
| Step 1 | inventory confirmed; two removals and three source repairs (S-21, S-22, S-23) applied, awaiting confirmation. Open: *"No field sustains…"* and *"several are in service"* |
| Step 5 | inventory sent (Round 94), with two source findings (S-24, S-25) to vote |
| Next | Step 6; Steps 7–8 last |

**The body is about 25 870 words.** Recomposition gains a few percent per block. In Steps 2 and 3 its main product was
