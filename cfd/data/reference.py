...
Kaynaklar `cfd/source/` altinda durur ve depoya girmistir.
...
2. Vektor cikarimi. PDF'teki sekil vektor grafikse egrinin dugum
   ...
   yollar dogrudan okunur (veri/nas_figure.py). Okunan sey cizimin kendi
...
LADSON_CD0 = dict(
    ...
    dosya="cfd/source/19880019495.pdf, PDF sayfa 90 (basili sayfa 88)",
    yontem=(
...
MCCROSKEY_CD0 = dict(
    ...
    dosya="cfd/source/2D NACA 0012 Airfoil Validation Case.pdf, sayfa 5",
    yontem=(
...
KOD_KOD = dict(
    ...
    dosya="cfd/source/NAS_Technical_Report_NAS-2016-01.pdf, Tablo 7.1 ve 7.2",
...
SST_SERBEST_AKIS = dict(
    ...
    dosya="cfd/source/NAS_Technical_Report_NAS-2016-01.pdf",
    mutinf=0.001,
...
DUZ_LEVHA = dict(
    ...
    dosya="cfd/source/NAS_Technical_Report_NAS-2016-01.pdf, Sekil 4.1 ve 4.2",
    ...
    yontem=(
        ...
        "veri/nas_figure.py, karsilastirma: plate/compare.py.\n"
        ...
        "plate/compare.py calismayi durdurur."),
    ...
    # nas_sekil.eksen_denetimi ve validation.md "DUZELTME 2".
...
PROFIL_CF = dict(
    ...
    dosya="cfd/source/NAS_Technical_Report_NAS-2016-01.pdf, PDF sayfa 44",
    kosul="M = 0.15, Re = 6.0e6, alfa = 0, 897 x 257 ag, ust yuzey",
    yontem=(
        "Vektor cikarimi (yontem 2), veri/nas_figure.py anahtar '7.4cf'.\n"
