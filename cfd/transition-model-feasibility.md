...
Tarih: 2026-09-06
Kaynaklar: `references/Langtry_2006_PhD.pdf`, `references/Medida_2014_PhD_Maryland.pdf`

## 1. Sorun

`paper/sections/06-reference-designs.md` §6.6'da C_D0 için iki rakam var:
...
`cfd/common/c_mesh.py`. Yani (i, j, k) indislemesi bize ait; duvar-normal
...
öneriliyor. Bizim ağda `_geometrik` (`cfd/common/c_mesh.py:139`) ilk hücre
