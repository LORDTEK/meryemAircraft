...
build attached here is at commit `cfc68f5`, path `paper/paper-v6.md`. Everything
...
**Implemented in `paper/build/links.py`.** For every `Section N.M` pointer, it takes
