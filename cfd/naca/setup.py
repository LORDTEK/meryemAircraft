...
from c_mesh import CAgi                                   # noqa: E402
...
def kur(dizin, kod="0012", Re=6e6, alfa=0.0, yplus=1.0,
    ...
    """Vakayi kurar; ag .msh olarak birakilir, cevrimi run.sh yapar.
    ...
    gecici=(T, dt0, dyaz)  zamana bagli cozum, pimpleFoam: T saniyeye kadar,
                           ...
                           thickness.py) kararli cozucu yakinsamaz; dogru
                           islem budur.
    """
    ...
    if gecici:
       ...
       # cozumden sonra yazilmis alanlardan common/forces.py ile
       # hesaplaniyor.
