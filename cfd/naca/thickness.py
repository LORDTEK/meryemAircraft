...
ama nedeni, ilk yazdigimdan BASKA cikti. Ikisi de kayitta:
  ...
  hiz kalintilari yine yukseliyor (naca/steady_solver.py). Neden
...
# iki bagimsiz kodla profil duzeyinde cakisiyor (bkz. validation.md).
...
# %25'te kalinti YUKSELIYOR, orasi gercekten kararsiz (bkz. transient.py).
#     python3 cfd/naca/thickness.py [model] [adim]
        ...
        if atilan:
            ...
            for v in atilan:
                print("  UYARI: %d%% satiri GECERSIZ -- C_L = %+.1e "
                      ...
                      "Kararli cozum degil; URANS gerekir (transient.py)."
