...
def yurut(harf, kok, model="kOmegaSST"):
    ...
    %12-14 altinda kaliyor (plate/model_discriminate.py), SA ise iki bagimsiz
    referans kodla +-0,06 u+ icinde cakisiyor (plate/compare.py).
...
if __name__ == "__main__":
    # kullanim:  sweep.py <A|B> [kok] [model]
