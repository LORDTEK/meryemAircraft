...
Bu betik SST'ye ozgu ayarlari tek tek degistirir. free.py serbest akis
...
Denenen degiskenler:
  ...
  omega_kitap  duvar fonksiyonu HIC kullanilmaz: omega duvarda yuz yuz
               ...
               iddia etmiyorum; aralik plate/omega_wall.py'de taraniyor.
...
def duzenle(vaka, hangi):
    ...
    if hangi == "omega_ham":
        ...
        import math
        sys.path.insert(0, os.path.join(BURA, "..", "common"))
        from foam_read import Ag                       # noqa: E402
        from forces import nu_oku                    # noqa: E402
...
if __name__ == "__main__":
    with Kilit(KOK):
        ...
        for v in VARYANT:
            ...
            r = subprocess.run([os.path.join(BURA, "run.sh"), vaka, "4"],
