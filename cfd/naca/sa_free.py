...
if __name__ == "__main__":
    with Kilit(KOK):
        ...
        for c in CARPAN:
            ...
            #
            # Artik ayristirilmis veri varsa continue.sh ile son yazilan
            ...
            if son is not None:
                print("[nuTilda_inf = %g nu] %d. adimdan surduruluyor"
                      % (c, son), flush=True)
                subprocess.run([os.path.join(BURA, "continue.sh"), vaka,
                                "3000", "4"], check=True)
            ...
            # belirler; sik yazim, yeniden baslamada continue.sh'in en fazla
