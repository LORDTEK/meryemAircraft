...
| aday S-28 | 95 | Adım 6E | "Its disc loading is 3.5 lb ft⁻²" yalnız turboşaft quadrotor; elektrikli 3 lb/ft² | **ayrışık** — çoğul (DeepSeek, Qwen), tekil kalsın (Grok), ChatGPT'nin önerisi "good quadrotor"u kaynağa yanlış atfediyor (J&S'de yok) | S |
| **R-4** | 96 | Adım 6D | oylanan S-27 cümlesi "The same table gives…" ile başlıyordu; önerdiğim yere konunca "the same table" bizim karşılaştırma tablomuza bağlandı (J&S Tablo 3 değil) — `v8_refs.py` yakaladı | geri alındı; "The same sizing set gives its two helicopter types at 5.4 to 7.2…" oylamada | **R (uygulanmadı)** |
| **R-5** | 96 | Adım 6D | oylanan zayıf silme ("These are the bounding combinations…") uygulanırsa sonraki "They are not four demonstrated aircraft states" yalnız etikete ("Examined envelope, 5.56 to 7.39") bağlanır | uygulanmadan yakalandı (P51); "The four corners are not demonstrated aircraft states" oylamada | **R (uygulanmadı)** |
| **R-6** | 96 | Adım 14C | benim yazdığım ve oylanan S-20 cümlesi "how long this aircraft's vertical phases draw the peak is not computed here" diyor; Adım 2 dikey fazların bir saatlik görevde "on the order of a minute" sürdüğünü söylüyor — CLAUDE §0.2 ihlali (bir şeyin olmadığını söylemeden önce olduğunu söyleyen bölüm aranmadı). Barrett'in askısı ≤ 20 s; bizimki mertebe olarak yaklaşık üç katı | oylamada — "this aircraft's vertical phases occupy about a minute in all (Section 2), and how long each draws the peak is not computed here" | **R (Claude)** |
| aday S-29 | 96 | Adım 7A, 1G | "Series-hybrid propulsion has established precedent in small uncrewed aircraft" — gövdede ve `references/`'te kaynak yok; Adım 1 Adım 7'ye, Adım 7 Adım 1'e işaret ediyor | okuyuculardan indirilebilir kaynak isteniyor | S |
