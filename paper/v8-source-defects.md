...
| **R-3** (aday) | 93 | Adım 14C | S-19 cümlesi girince paragrafın "the figures available are of **three** different kinds" ve "unlike ratings" listesi eksik kaldı: 3 kW/kg dördüncü tür (literatürden alıntılanmış, türü belirtilmemiş) | oylamada — "four different kinds" + listeye "and a literature figure the study cites without its rating" | **R** (oylanan eklemenin yan etkisi; oylamada kimse — ben de — görmedi) |
| aday S-20 | 93 | Adım 14C | Barrett'in 34–35. sayfası çevre metniyle okundu (Qwen P1): çalışma, darbe akım sınırlarının sürekli sınırı iki kattan fazla aşabildiğini ve hover'ının 20 s ya da daha kısa sürdüğünü söyleyip **"it may be possible to design a battery pack with the required specific power using existing technology"** sonucuna varıyor; biz almamışız. Ayrıca 34. sayfa "existing batteries"ı "existing lithium-ion battery prototypes [39]" diye daraltıyor | oylamada | S |
| aday S-21 | 93 | Adım 1F | "audited explicitly against [üç fatura], at two scales" — Adım 12: ikinci ölçekte Bill 1 sınanmadı | oylamada — "the last two of them at two scales" | S |
| aday S-22 | 93 | Adım 1E | DelftaCopter sabit hatve uzlaşmasının ikinci tanığı olarak alıntılanıyor; rotoru **değişken hatveli** (cyclic + collective) ve aynı makale değişken hatveyi o uzlaşmanın çaresi olarak, mekanizma bedeliyle adlandırıyor | oylamada — ne olduğunu söyle | S |
| aday S-23 | 93 | Adım 1B | "tilt-rotors from the 1980s" — NASA incelemesi: XV-3 ilk askı Ağustos 1955, XV-15 Mayıs 1977 | oylamada | S |
