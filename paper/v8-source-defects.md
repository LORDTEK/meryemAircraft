...
| **R-1** | 91 | Adım 9, 4. madde | oylanan silme uygulansaydı "A count is not a reliability argument" hemen önceki "Part count"a bağlanacaktı (ters anlam) | **uygulanmadan yakalandı**; R önerisi oylamada | **R (uygulanmadı)** |
