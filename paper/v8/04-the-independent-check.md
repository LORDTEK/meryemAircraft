...
| İddia | Kaynak |
|---|---|
| **Tur 115 — S-43 onarıldı** (Tur 114; dört okuyucu + Claude; Grok'un sözcükleri): "…in its own words, on a comparison the check does not use as its test." Kapsam alıntıdan önce; "a" (denetim birden çok karşılaştırmayı dışarıda bırakıyor). Cümle alıntıyla birlikte korunan; eski giriş emekli (Grok P95). Kaynak J&S 2022 pdf s. 11: kıyas tümü elektrikli lift+cruise / quadrotor | Tur 114 metni §2 |
| **Tur 114 — Adım 4 uzunluk geçişi** (Tur 113; dört okuyucu + Claude): M1 ("The accounting says … nothing more …" + "Sections 10 and 14 are about exactly that possibility …"; aynı nokta Adım 3'ün üçlü reddinde ve Adım 9 madde 6'da) ve M2 (kapanış geçişi) Ek S4'e; O-a (eğme mekanizması yan cümlesi) gövdede. 1 351 → 1 268. S-43 (b) sözcükleri oyda | Tur 113 metni §4 |
