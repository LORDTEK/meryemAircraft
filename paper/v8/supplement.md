...
### Section 2 as it stood before recomposition into result sentences (frozen snapshot, complete)
...
### Section 3 as it stood before recomposition into result sentences (frozen snapshot, complete)
...
### Section 9 as it stood before the length pass (frozen snapshot, complete)
...
### Section 10 as it stood before recomposition into result sentences (frozen snapshot, complete)
...
### Section 11 as it stood before recomposition into result sentences (frozen snapshot, complete)
...
### Section 12 as it stood before recomposition into result sentences (frozen snapshot, complete)
...
### Section 13 as it stood before recomposition into result sentences (frozen snapshot, complete)
...
| **The competitor's lift-group mass.** It is one of the two assumed quantities that decide the sign of the fixed-take-off-mass ordering in Section 13; the other is the competitor's cruise propeller efficiency. | Section 13's sensitivity, not a claim | **Measured inventories** of lift-plus-cruise aircraft of this class |
...
### Section 14 as it stood before recomposition into result sentences (frozen snapshot, complete)
