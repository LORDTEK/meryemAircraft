...
`references/` altına yükleyeceksiniz; ben okuyup metne bağlarım, ve
`paper/references.md`'ye hangi sayının hangi sayfadan geldiğini yazarım.
...
> Siz indirin, `references/` altına koyun, ben okuyayım.
>
...
`paper/references.md`'ye yazar, metne bağlarım. Refleks kesit (Şart 2) en
