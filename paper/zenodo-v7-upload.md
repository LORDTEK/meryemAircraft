...
| `paper-v7.md` | `paper/` | Makine okunabilir ana metin |
| `paper-v7-supp.md` | `paper/` | Eklerin markdown hali |
...
**Description:** `paper/zenodo-v7.md` içeriğini olduğu gibi yapıştır. Metin
...
`drones-submission.md`'deki gönderim notuna sürüm DOI'sini de eklerim.
...
| | |
|---|---|
| `paper-v7.md` SHA-256 (ilk 12) | aşağıdaki komut verir |
| commit | `git log -1` |

```
sha256sum paper/paper-v7.md | cut -c1-12
```

Depodaki `paper-v6.md` **yatırılan v6'ya geri alındı**, yani artık Zenodo'daki
v6 ile birebir aynı. Bir süre öyle değildi ve bunu `paper/VERSIONS.md`
