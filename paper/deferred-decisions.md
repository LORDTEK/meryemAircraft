...
| **E4** | **Kısaltmanın hızı ve yedek yol.** Tur 67 ölçümü: bu hızla 7 500'e ~50 tur (ortalama), >100 tur (son beş turun hızı). | **YAZARIN ÇERÇEVESİ (Tur 67):** çözüm budamak (bölüm bütçesi) olamaz; **en az 6–8 tur daha makul adım**; okuyucuların çözümleri dinlenecek. **Yedek:** iyi fikir gelmezse *"getirmiş olduğum eşsiz yenilik anlatılarının dışında kalan hesap kısımları"* yontulur. **Her tur bakılacak:** gelen çözümler yan yana; 6–8 tur dolduğunda yedek yol yazara hatırlatılır. **Tur 68:** dört çözüm geldi; üçü taslak (Grok, ChatGPT, Qwen), biri tutma listesi (DeepSeek); Claude tutma listesini geri çekti; dördünden birer parçalı plan oylamada (Tur 68 metni §6). **Yazarın kararı bekleniyor.** | Claude (ölçüm), yazar (çerçeve) |
