...
mkpaper.py her sekli ilk atif aldigi paragrafin ardina koyar ve dogru koyar;
kusur metindeki atif sirasindaydi. Coz(um: atiflar {1:1, 2:2, 12:3, 3:4, 4:5,
5:6, 6:7, 7:8, 8:9, 11:10, 9:11, 10:12} ile yeniden numaralandi, figures/cikti
dosya adlari ve figures/uretim betik adlari ayni esleme ile dondu.

Bu liste ile figures/output/ birlikte doner. Biri donup oteki donmezse
mkpaper.py eksik dosyayi soyler; yine de ikisini ayni commit'te tutun.
"""

FIGS = [
 ("1",  "fig01-two-families.png",
 ...
 ("12", ["fig12a-transition-rotation-time.png","fig12b-climbing-entry.png"],
