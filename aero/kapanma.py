...
SINIR. Kutle kurulusu kutle.py'nin kendisidir; bu betik onu yeni bir
tampon kutlesiyle ve yeni bir olcekle tekrar cagirir. kutle.py'nin butun
...
from kutle import butce                                    # noqa: E402
