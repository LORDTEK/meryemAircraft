...
x_cg icin: rotation.py'nin HACIM AGIRLIKLI yerlestirmesi. Bu bir OLCUM
...
CG_KURAL = 0.802                 # rotation.py, hacme orantili yerlestirme
...
def konvansiyon_denetimi():
    ...
    # 1. BASLANGIC NOKTASI. rotation.py x'i kok hucum kenarindan, firara +
