...
fig.save(OUT+"/sekil05-uc-gorunus.png",dpi=(600,600)); print("Sekil 5:",fig.size)
...
fig.save(OUT+"/sekil06-serbest-gorunus.png",dpi=(600,600)); print("Sekil 6:",fig.size)
...
fig.save(OUT+"/sekil10-iki-olcek.png",dpi=(600,600)); print("Sekil 10:",fig.size)
