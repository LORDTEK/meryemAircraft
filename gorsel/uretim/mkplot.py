...
fig.tight_layout()
fig.savefig(OUT+"/sekil12a-gecis-donus-suresi.png",dpi=300)
fig.savefig(OUT+"/sekil12a-gecis-donus-suresi.svg")
...
fig.tight_layout(); fig.savefig(OUT+"/sekil12b-tirmanarak-giris.png",dpi=300)
fig.savefig(OUT+"/sekil12b-tirmanarak-giris.svg"); print("Sekil 12b yazildi")
