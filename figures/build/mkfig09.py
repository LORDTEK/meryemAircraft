...
OUT="/home/user/meryemAircraft/figures/cikti"; D2R=math.pi/180
...
fig.savefig(OUT+"/fig09-strip-slipstream.png",dpi=300,bbox_inches="tight")
fig.savefig(OUT+"/fig09-strip-slipstream.svg",bbox_inches="tight"); print("Sekil 9 yazildi")
