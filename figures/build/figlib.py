...
Model dosyasi (figures/source/body-study.html) bir IIFE icindedir ve disaridan
...
MODEL = os.path.join(KOK, "figures", "source", "body-study.html")
...
def model_hazirla():
    ...
    if CAPA not in kaynak:
        raise RuntimeError(
            "Model dosyasinda enjeksiyon capasi bulunamadi. body-study.html "
