...
fig.tight_layout(); fig.savefig(OUT+"/fig01-two-families.png",dpi=300,bbox_inches="tight")
fig.savefig(OUT+"/fig01-two-families.svg",bbox_inches="tight"); print("Sekil 1")
...
fig.tight_layout(); fig.savefig(OUT+"/fig04-three-bills.png",dpi=300,bbox_inches="tight")
fig.savefig(OUT+"/fig04-three-bills.svg",bbox_inches="tight"); print("Sekil 4")
