...
Makalenin atıf listesi burada değil, `paper/bibliography-en.md` dosyasındadır.
...
|---|---|---|
| `cfd/source/` | CFD doğrulama kaynakları (NASA TMR, NAS teknik raporu, NACA 0012 doğrulama vakası) | Sayısal iddialara **dayanak**. `cfd/data/reference.py` ve `cfd/common/c_mesh.py` bu dosyalara sayfa numarasıyla atıf yapar; taşınırsa kod bozulur. |
| `references/` (bu dizin) | Genel okuma kaynakları | Koda gömülü atıf yok. Okunup anlaşılmak için var. |
...
| `Medida_2014_PhD_Maryland.pdf` | γ-Re_θ-SA: geçiş denklemlerini Spalart–Allmaras'a bağlar. Bkz. `cfd/transition-model-feasibility.md`. |
