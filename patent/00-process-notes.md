...
| Belge | Dosya | Durum |
|---|---|---|
| Tarifname | `pdf/01-description.pdf` — 8 sayfa | ✅ hazır |
| İstemler | `pdf/02-claims.pdf` — 3 sayfa, 17 istem | ✅ hazır |
| Özet | `pdf/03-abstract.pdf` — 1 sayfa, 127 kelime | ✅ hazır |
| Resimler | `pdf/04-figures.pdf` — 5 sayfa | ✅ hazır |
| Başvuru formu | EPATS üzerinden çevrimiçi | — |

**Kaynak metinler:** `01-description.md`, `02-claims.md`, `03-abstract.md`
(çalışma notlarıyla birlikte). PDF'ler bu notlardan **arındırılmış** temiz
sürümlerdir; içerik `description_content.py` içinde tutulur, `mkpdf.py` ile
üretilir.
...
dönüştürülmedi). Üretici betik: `figures/build/patent-figures.py`
...
(`description_content.py`, `01-description.md`, `02-claims.md`)
...
(`references/7178ed2b-...pdf`, "Patent kılavuz 2022", 48 s.) repoya koydu.
...
`check.py` üretilen PDF'leri ölçerek denetliyor (görsel kontrol değil):
...
**Kapsam aşımı yok.** `description_content.py`, `01-description.md`,
`02-claims.md`, `03-abstract.md` üzerinde `git diff` boş; 17 istemin hepsi
