# -*- coding: utf-8 -*-
"""KAPAK MEKTUBUNU PDF'E BASAR -- makale/pdf/meryemAircraft-kapak-mektubu.pdf

NEDEN VAR. Drones kapak mektubunu PDF olarak istiyor. Metin duz metin
olarak drones-kapak-mektubu.txt'te duruyor ve TEK KAYNAK odur; bu betik
...
KAYNAK = os.path.join(MAKALE, "drones-kapak-mektubu.txt")
